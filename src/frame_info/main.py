...
"""
main.py
This is the main entry point for the frame_info Python application.
"""
...
from frame_info import __version_number__
# from src.frame_info.extension.my_module import MyClass
...
def register_module_spec() -> None:
    ...
    if str(spec.name).find('frame_info') < 0:
        raise ValueError(f'Package name is not "frame_info", name: {spec.name}')
